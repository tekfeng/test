      ...
      init : function(params) {
        ...
        if ( $('body').find('.' + elemClass).length != 0 && $('body').find('.' + elemClass).attr('data-popmodal_id') == elem.attr('data-popmodal_id') ) {
          ...
          if (_options.showCloseBut) {
            closeBut = $('<button type="button" class="close icon-link-cancel">&nbsp;</button>');
          }
  ...
  $.fn.notifyModal = function(method) {
    ...
    var methods = {
      init : function(params) {
        ...
        var closeBut = $('<button type="button" class="close icon-link-cancel">&nbsp;</button>');
        if (elem[0] == undefined) {
          elem = elem['selector'];
        } else {
        ...
        elemObj.find('.notifyModal_content').css({
          maxHeight : '70%'
          // top : '%50 !important',
          // marginTop : -Math.min($(window).height() - 100, elemObj.find('.notifyModal_content').height())/2
        });
  ...
  $.fn.dialogModal = function(method) {
    ...
    var methods = {
      init : function(params) {
        ...
        dialogCloseBut = $('<button type="button" class="close icon-link-cancel">&nbsp;</button>');

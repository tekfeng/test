...
ActiveRecord::Schema.define(version: 20150722044153) do
  ...
  create_table "countries", force: :cascade do |t|
    ...
    t.boolean  "on_the_top", limit: 1,   default: false
  ...
  create_table "mountain_guides", force: :cascade do |t|
    t.string   "name",        limit: 255
    t.string   "period",      limit: 255
    t.integer  "total_climb", limit: 4,   default: 0
    t.integer  "penalty",     limit: 4,   default: 0
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "is_head_of_department",  limit: 1,   default: false
  end
